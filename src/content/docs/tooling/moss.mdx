...
atomically updating OS, we created our own solution: [moss](https://github.com/AerynOS/os-tools).
...
means all packages in AerynOS are **stateless**. That also adds some complexities such as running transactional
