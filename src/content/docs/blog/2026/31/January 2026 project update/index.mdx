...
Progress has been made around our branding with efforts towards a new website design and a healthy discussion and proposals for a new AerynOS logo. You may recently have seen that AerynOS is taking a stronger stance against the use of LLMs and generative AI. In full transparency, our current logo was AI generated and we actively want to move to a human created logo for the reasons mentioned in our [LLM policy](https://github.com/aerynOS/.github?tab=contributing-ov-file#llm-contributions).

Additional progress has been made project-wide on our documentation and we have also made improvements to our CDN implementation for improved package delivery.

Our efforts are seemingly well received, we are seeing an influx of new members joining our Zulip server and getting involved with AerynOS, whether through general discussion or through packaging efforts. We have also seen a jump in our followers across our various social media accounts and generally a more positive reception of what AerynOS is trying to achieve in the Linux space.
...
- KDE Gear 25.12.1
- KDE Plasma 6.5.5
- brush 0.3.0-dev (bash compatible shell built w/ Rust)
