...
AerynOS is currently running on 6.16.8. Whilst we are aware that Linux 6.17 was released on 28th September 2025, the AerynOS team takes the view that for larger software stacks, to hold back a "few" point releases after a major version update to ensure there are no unexpected issues is the wise thing to do for a team our size.

Whilst AerynOS is a rolling release distribution, we don't aim to be on the bleeding edge just for the sake of being on the bleeding edge.

## Gnome 49

The team updated to Gnome 49 in the fortnight following its release meaning it's now available in our repository. Given the way Gnome updates and how extensions then follow suit, we are aware that many extensions have not yet been updated for compatibility with Gnome 49.
...
## Infra stabilization workstream

2025 has seen a massive lift in our infra code with the re-write to Rust taking place in Q2, and its stabilisation being pursued from the end of Q2 and up until now.
...
During the last couple of months, we had a new contributor join us and begin working on the Cosmic stack. His contributions have been invaluable to the team and we thank him for his engagement. 

Unfortunately, due to personal reasons, he is having to take a temporary step back from the project. He has shared his methodology for providing updates to the Cosmic packages and we already have willing contributors picking up the tasks from which he was forced to step back.
...
One area in which we often receive feedback is our website. Whilst we are in our Alpha state, it has not been our highest priority to "fix". We do have a couple of interested contributors wanting to work on our website to improve the overall look and feel of the project, though.
...
Please do not take this as any indication of a slow down in the project. If anything, we have an increasing number of developers working on different areas of our tooling stack and are seeing our development and packaging activity picking up.
...
That's it for this monthly roundup. Thanks for reading, and we hope to see you around in our community. :handshake: :rocket:
