...
KDE Plasma has been updated to 6.5.3, KDE Frameworks to 6.20.0.
...
Another area we have been reviewing is how we serve ISO downloads to our users. We currently only offer a direct download via our package server behind a CDN. As a small opperation, this has suited us well enough, however users in certain locations don't nessesarily benefit from this solution.
