...
culminated in having to resign. Naturally I've been working exclusively on Serpent OS since then, but
...
Or provide appliances. Or &lt;insert your idea here&gt;. We're building a set of tools and principles to facilitate
...
with ABI tracking for dependency chain invalidation, we can determine which recipes need to run again as part of an invalidation-solver loop
