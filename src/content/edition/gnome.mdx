...
We use this Gnome Edition to serve as a vehicle for our ‘lichen’ live installer which is able to install ‘GNOME’, ‘KDE Plasma’, ‘Cosmic’ and a ‘Terminal Only’ install of AerynOS. It will always pull the latest packages from our repository at the time of installation.
