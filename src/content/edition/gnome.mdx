...
**NB:** *Ventoy* is currently [not compatible with AerynOS](https://github.com/ventoy/Ventoy/issues/3550). Use tools such as Etcher or `dd` with a separate USB stick instead.
